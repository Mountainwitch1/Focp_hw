...
if __name__ == "__main__":
    main()
# OS platform that's being used is: macOS
...
#  \Users\abineshacharya\Desktop\FOCP\week_5>python Abinesh_Acharya_P5.py 12 33 4
...
# python Abinesh_Acharya_P5.py 12 33 41 22
