...
#4
name = "Abinesh Acharya"
age = 19.712
print(f"{name:>20} {age:$>20.2f}")
    # Abinesh Acharya $$$$$$$$$$$$$$$19.71
...
#7
with open(r'/Users/abineshacharya/Desktop/info.txt', 'r') as file:
    for line in file:
        print(line,end='')
...
#10
with open(r'/Users/abineshacharya/Desktop/info.txt', 'a') as file:
    file.write("Abinesh Acharya says hello....\n")
age = 19
with open(r'/Users/abineshacharya/Desktop/info.txt', 'a') as file:
    file.write(str(age) + "\n")
# This is a text file
